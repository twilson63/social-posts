  ...
  <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
    <a href="#" class="block shrink-0">
      <img
        ...
        class="h-14 w-14 mask mask-circle object-cover"
      />
    </a>

    <div>
      <h3 class="font-medium sm:text-lg">
        <span class="float-right text-xs font-thin">26m</span>
        <a href="#" class="hover:underline"> Rakis </a>
        <span class="font-thin text-sm">@rakis</span>
      </h3>

      <p class="line-clamp-2 text-xs sm:text-sm text-gray-700">
